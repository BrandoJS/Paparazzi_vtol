...
/* set pin as output for switch control */
#define SW_INIT() {					        \
    GPIO_InitTypeDef GPIO_InitStructure; 		        \
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE);	\
...
#define CM1_ON() {GPIOC->BSRR = GPIO_Pin_3;}
#define CM1_OFF() { GPIOC->BRR  = GPIO_Pin_3;}
#define CM2_ON() {GPIOC->BSRR = GPIO_Pin_5;}
#define CM2_OFF() { GPIOC->BRR  = GPIO_Pin_5;}
