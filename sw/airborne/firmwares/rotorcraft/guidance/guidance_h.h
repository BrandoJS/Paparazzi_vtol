...
extern int32_t guidance_h_pngain;
extern int32_t guidance_h_dngain;
extern int32_t guidance_h_ingain;
extern int32_t guidance_h_nngain;
extern int32_t guidance_h_angain;
...
#define guidance_h_SetKin(_val) {			\
    guidance_h_ingain = _val;			\
    INT_VECT2_ZERO(guidance_h_pos_err_sum);	\
  }
